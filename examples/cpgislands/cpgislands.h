...
#ifndef _cpgislands_h_
#define _cpgislands_h_
...
typedef bfloat CpGislandReal;
// define type for a 'short' real -- usually double, but can be logspace for efficiency
typedef double CpGislandShortReal;



class CpGislandBaumWelch {
    public:
    // Default copy constructor is used.
    // Void constructor:
    CpGislandBaumWelch() { resetCounts(); }
    ...
    bfloat transitionBaumWelchCount0[1];
    static int transitionIdentifier0[1];   
    static const int transitionDimension0 = 1;
    bfloat transitionBaumWelchCount1[4][6];
    static int transitionIdentifier1[6];   
    static const int transitionDimension1 = 6;
    bfloat emissionBaumWelchCount1[4][2];
    static int emissionIdentifier1[2];   
    static const int emissionDimension1 = 2;
    bfloat emissionBaumWelchCount2[4][4][1];
    static int emissionIdentifier2[1];   
    static const int emissionDimension2 = 1;
    private:
